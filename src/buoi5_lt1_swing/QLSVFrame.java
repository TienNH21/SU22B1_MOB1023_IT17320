...
import buoi1_lt1.Nguoi;
import buoi1_lt1.NguoiDAOInterface;
import buoi1_lt1.QuanLyDanhSach;
import buoi1_lt1.SinhVien;
...
public class QLSVFrame extends javax.swing.JFrame {
    ...
    public QLSVFrame() {
        ...
        this.qlds.insert(new SinhVien("PH1", "UDPM", "NVA", "HN", 1));
        this.qlds.insert(new SinhVien("PH2", "TKTW", "NTB", "ND", 0));
        this.qlds.insert(new SinhVien("PH3", "LTMT", "NVC", "HN", 1));
    ...
    private void loadTable()
    {
        ...
        // Xóa toàn bộ dữ liệu đang có trên Table
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        tblSV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SV", "Họ Tên", "Địa Chỉ", "Giới Tính", "C/Ngành"
            }
        ) {
